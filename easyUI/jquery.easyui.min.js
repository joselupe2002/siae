...
},message:"Por favor ingrese una cuenta de correo valida."},url:{validator:function(_44d){
...
},message:"Por favor ingrese una URL valida."},length:{validator:function(_44e,_44f){
var len=$.trim(_44e).length;
return len>=_44f[0]&&len<=_44f[1];
},message:"Ingrese un valor entre {0} and {1}."},remote:{validator:function(_450,_451){
var data={};
data[_451[1]]=_450;
...
$.fn.filebox.defaults=$.extend({},$.fn.textbox.defaults,{buttonIcon:null,buttonText:"Examinar",buttonAlign:"right"});
})(jQuery);
(function($){
function _49a(_49b){
...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,firstDay:0,weeks:["D","L","M","M","J","V","S"],months:["Ene","Feb","Mar","Abr","May","Jun","Jul","Ago","Sep","Oct","Nov","Dic"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:(function(){
var d=new Date();
...
_972(this,q);
}},currentText:"Hoy",closeText:"Cerrar",okText:"Ok",buttons:[{text:function(_985){
