	...
	<div class="widget-box widget-color-purple" id="principal">
			  <div class="widget-header widget-header-small" style="padding:0px;">
			      <div class="row" >	
						...
						<div id="lostipos" class="col-sm-2">
						</div>       			 
					
						<div class="col-sm-2" style="padding-top:14px;">
						    <button title="Cargar las Asignaturas del Alumno" onclick="cargarInformacion();" class="btn btn-white btn-info btn-round" value="Agregar"> 
								<i class="ace-icon green fa fa-search bigger-100"></i><span class="btn-small"> Asignaturas</span>            
							</button>																														 									
						</div>
		            </div> 
		      </div>
