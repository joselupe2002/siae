...
<html lang="es">
	...
	<body id="grid_<?php echo $_GET['modulo']; ?>" style="background-color: white;">
		  ...
		  <div class="row alert alert-success" id="prorroga" style="padding:0px; margin:0px;">
...
<script src="<?php echo $nivel; ?>nucleo/pa_prorrogas/pa_prorrogas.js?v=<?php echo date('YmdHis'); ?>"></script>
