...
<script type="text/javascript">
		...
		var nombreuser="<?php echo $_SESSION["usuario"];	?>";
...
/*=========================================================================*/
	...
	function cargarAsesores(){
	    elsql="select * from vedescarga i, pempleados where DESC_PROFESOR=EMPL_NUMERO AND i.DESC_CICLO=2201 AND i.DESC_ACTIVIDAD IN ('124','DC04') ORDER BY DESC_PROFESORD";
	    parametros={sql:elsql,dato:sessionStorage.co,bd:"Mysql"}
	    $.ajax({
			   type: "POST",
			   data:parametros,
