...
var colores=["4,53,252","238,18,8","238,210,7","5,223,5","7,240,191","240,7,223","240,7,7","240,7,12"];
	...
	function cargarProgramacion (){
		...
		"ifnull(TIPORETRASO,'') as TIPORETRASO, (select CATA_DESCRIP from scatalogos where CATA_TIPO='AVPROGTIPRET' AND CATA_CLAVE=TIPORETRASO) AS TIPORETRASOD, "+
		"ifnull(TIPOCIERRE,'') as TIPOCIERRE, (select CATA_DESCRIP from scatalogos where CATA_TIPO='AVPROGTIPTER' AND CATA_CLAVE=TIPOCIERRE) AS TIPOCIERRED, OBS "+
