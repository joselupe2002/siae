...
/*===================================================================================================================*/
			...
			{				
                ...
                " AND e.ALUCTR='".$_GET["matricula"]."' and e.BAJA='N' and CERRADO='N' and IFNULL(MATE_TIPO,'0') NOT IN ('I','OC','T')".
            ...
            function boleta($linea) {
                ...
                if ($data) {
                        ...
                        $totcred=0;   
                            ...
                            $this->Cell(10,3,$nrep,1,1,'R');
                            $this->setX(120);
                            $this->Cell(25,3,utf8_decode("CRÉDITOS:"),1,0,'R');
                            $this->Cell(10,3,$totcred,1,1,'R');
                            $this->setX(120);
                            $this->Cell(25,3,"CRED. APR:",1,0,'R');
                            $this->Cell(10,3,$crapr,1,1,'R');
