	...
	<div class="widget-box widget-color-purple" id="principal">
			  <div class="widget-header widget-header-small" style="padding:0px;">
			      <div class="row" >	
						...
						<div id="losmapas" class="col-sm-3">
						</div> 

						<div class="col-sm-2" style="padding-top:14px;">
						    <button title="Cargar los residentes" onclick="cargarInformacion();" class="btn btn-white btn-info btn-round" value="Agregar"> 
								<i class="ace-icon green fa fa-search bigger-100"></i><span class="btn-small"> Residentes</span>            
							</button>																														 									
						</div>
		            </div> 
		      </div>
              ...
              <div class="widget-body">
				   <div class="widget-main">
					...
					<div class="widget-footer bg-primary" style="padding-top:5px;">
					     <div class='row'>
						      <div class="col-sm-2">
								   <span>Plan:</span> <span id="elmapa" class="badge badge-warning"></span>
							  </div>
							  <div class="col-sm-4">
...
<script src="rescalifica.js?v=<?php echo date('YmdHis'); ?>"></script>
