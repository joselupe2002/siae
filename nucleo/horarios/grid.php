		  ...
		  <div class="widget-box widget-color-green" id="principal">
			  <div class="widget-header widget-header-small" style="padding:0px;">
			      <div class="row" >		                    		
						...
						<div id="losplanes" class="col-sm-3" style="padding-top:10px;">
						    <button title="Agregar Asignaturas" onclick="agregarAsignatura();" class="btn  btn-white btn-primary" value="Agregar"> 
								<i class="ace-icon green fa fa-plus bigger-160"></i><span class="btn-small"></span>            
							</button>
						</div>
		            </div> 
		      </div>
