	...
	<div class="widget-box widget-color-green" id="principal">
			      ...
			      <div class="row" >	
						...
						<div class="col-sm-3" style="padding-top:14px;">
                            <button title="Ver Todas las Actividades de Desarga" onclick="cargarInformacion();" class="btn btn-white btn-info btn-round" value="Agregar"> 
								<i class="ace-icon red fa fa-user bigger-140"></i><span class="btn-small">Ver Act. Des.</span>            
							</button>
						    <button title="Crear Planes de Descarga" onclick="crearPlan();" class="btn btn-white btn-info btn-round" value="Agregar"> 
								<i class="ace-icon green fa fa-group bigger-140"></i><span class="btn-small">Crear Plan</span>            
							</button>																												 									
						</div>
		            </div> 
		      </div>
              ...
              <div class="widget-body">
				   <div class="widget-main">
					...
					<div calls="widget-header" id="pie"> </div>
			   </div>
		</div>
