...
<html lang="es">
	<head>
		...
		<link rel="stylesheet" href="<?php echo $nivel; ?>assets/css/fullcalendar.min.css" />
	...
	<div class="widget-box widget-color-purple" id="principal">
			  <div class="widget-header widget-header-small" style="padding:0px;">
			      <div class="row" >	
						...
						<div id="lostramites" class="col-sm-6" >
						</div>                    				
				
					
						<div class="col-sm-6" style="padding-top:14px;">
						    <button title="Ver mi calendario de citas" onclick="verCitas();" class="btn btn-white btn-info btn-round"> 
...
<script src="<?php echo $nivel; ?>js/chartjs/Chart.min.js"></script>

<!-- page specific plugin scripts -->
<script src="<?php echo $nivel; ?>assets/js/fullcalendar.min.js"></script>



<script src="pa_citas.js?v=<?php echo date('YmdHis'); ?>"></script>
<script type="text/javascript">
   usuario="<?php echo $_SESSION["usuario"];?>";
   essuper="<?php echo $_SESSION["super"];?>";
   institucion="<?php echo $_SESSION["INSTITUCION"];?>";
   campus="<?php echo $_SESSION["CAMPUS"];?>";
