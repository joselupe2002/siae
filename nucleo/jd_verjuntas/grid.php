...
<html lang="es">
	...
	<div class="page-header">
		<div class="row text-center" >
			<div class="col-sm-3" id="regreso"></div>
			<div class="col-sm-6">
				<span class="fontAmaranthB bigger-240 text-success">JUNTAS DIRECTIVAS </span></div>
			</div>
...
<script src="jd_verjuntas.js?v=<?php echo date('YmdHis'); ?>"></script>
