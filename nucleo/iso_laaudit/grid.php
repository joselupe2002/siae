	...
	<div class="widget-box widget-color-green" id="principal">
			  <div class="widget-header widget-header-small" style="padding:0px;">
			      <div class="row" >	
						...
						<div id="lasauditorias" class="col-sm-3" >
						</div>                    				
              ...
              <div class="widget-body">
				   <div class="widget-main">				      
				       <div class="row">							   
					       <div id="botones" class="sigeaPrin col-sm-12 bg-primary">    

						   </div>
						   <div class="row">
								<div id="titulos" class="sigeaPrin col-sm-12">    
...
<script src="iso_laaudit.js?v=<?php echo date('YmdHis'); ?>"></script>
