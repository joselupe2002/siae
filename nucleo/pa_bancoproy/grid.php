...
<html lang="es">
	...
	<div class="page-header">
		<h1>Proyectos Internos / Externos<small><i class="ace-icon fa fa-angle-double-right">
				</i>Residencia Profesional 
		</small></h1>
	</div><!-- /.page-header -->
	<div id="principal" class="sigeaPrin"> 
...
<script src="pa_bancoproy.js?v=<?php echo date('YmdHis'); ?>"></script>
