...
function grabarPorcentajes(){
	...
	$('#tabInformacion tr').each(function () {
		if (c>0) {
			 ...
			 profesor = $(this).find("td").eq(7).html();
			 profesord = $(this).find("td").eq(8).html();
			 materia = $(this).find("td").eq(9).html();
			 materiad = $(this).find("td").eq(10).html();
			 semestre = $(this).find("td").eq(11).html();
			 grupo = $(this).find("td").eq(12).html();
