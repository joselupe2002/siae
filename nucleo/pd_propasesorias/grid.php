			      ...
			      <div class="row" >	
						...
						<div class="col-sm-2" style="padding-top:14px;">
						    <button title="Buscar Registros" onclick="cargarInformacion();" class="btn btn-white btn-info btn-round" value="Agregar"> 
								<i class="ace-icon green fa fa-search bigger-140"></i><span class="btn-small fontRoboto"> Ver Agenda</span>            
							</button>													 									
						</div>
...
<script src="pd_propasesorias.js?v=<?php echo date('YmdHis'); ?>"></script>
